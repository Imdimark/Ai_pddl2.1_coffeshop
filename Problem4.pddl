(define(problem Problem4)
    ...
    (:goal(and
		 ...
		 (<(needed-biscuits t1 ag1)1) (<(needed-biscuits t4 ag1)1)(<(surf_m t4)1)(<(surf_m t1)1)(<(surf_m t3)1) (<(consumed-drink t1 )1) (<(consumed-drink t3)1) (<(consumed-drink t4)1)
    ))
